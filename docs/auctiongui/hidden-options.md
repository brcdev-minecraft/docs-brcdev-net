...
There are some hidden configuration options that can resolve some potential issues with AuctionGUI+ on some setups, along with provide additional behavior to the plugin, that may be potentially dangerous.
